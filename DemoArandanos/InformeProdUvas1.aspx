<%@ Page Title="" Language="C#" MasterPageFile="~/MasterUva1.Master" AutoEventWireup="true" CodeBehind="InformeProdUvas1.aspx.cs" Inherits="DemoArandanos.InformeProdUvas1" %>
...
<h1>Informe Producción Viñedos</h1>
    ...
    <form runat="server">
            ...
            <div id="printableArea">
                ...
                <div class="col-md-12">
                    <div class="visible-print">
                        <h2>Informe de Producción Viñedos</h2>
                        <br />
                        <h5>Desde:
                ...
                <div class="col-md-4">
                    <h3>Total Bins:
                <asp:Label ID="lbltotalbins" runat="server" Text=""></asp:Label></h3>
                    <h3>Total Kilos Neto aprox:
                ...
                <asp:Label ID="lbltotaltrabajadores" runat="server" Text=""></asp:Label></h3>
                    <h3>Promedio Bins/Trabajador:
                <asp:Label ID="lblprombinstrab" runat="server" Text=""></asp:Label></h3>
                </div>
            </div>
            <div class="col-md-3">
                <br />
        ...
        <div class="col-md-2">
            ...
            <asp:SqlDataSource ID="dsFundoVista" runat="server" ConnectionString="<%$ ConnectionStrings:Modelo7 %>" SelectCommand="SELECT DISTINCT ID_Fundo, Nombre FROM VistaAll WHERE ID_Producto = '33' and (ID_Variedad LIKE @ID_Variedad + '%')">
                <SelectParameters>
            ...
            <asp:SqlDataSource ID="potrerosDEfundoVista" runat="server" ConnectionString="<%$ ConnectionStrings:Modelo7 %>" SelectCommand="SELECT DISTINCT ID_Potrero, nombrePotrero FROM VistaAll WHERE ID_Producto = '33' and (ID_Fundo LIKE @ID_Fundo + '%') AND (ID_Variedad LIKE @ID_Variedad + '%')">
                <SelectParameters>
            ...
            <asp:SqlDataSource ID="sectoresDEpotreroVista" runat="server" ConnectionString="<%$ ConnectionStrings:Modelo7 %>" SelectCommand="SELECT DISTINCT ID_Sector, nombreSector FROM VistaAll WHERE ID_Producto = '33' and (ID_Fundo LIKE @ID_Fundo + '%') AND (ID_Potrero LIKE @ID_Potrero + '%') AND (ID_Variedad LIKE @ID_Variedad + '%')">
                <SelectParameters>
