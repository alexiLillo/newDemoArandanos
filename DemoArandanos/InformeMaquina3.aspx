<%@ Page Title="" Language="C#" MasterPageFile="~/MasterInformes.Master" AutoEventWireup="true" CodeBehind="InformeMaquina3.aspx.cs" Inherits="DemoArandanos.InformeMaquina3" %>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="max-height: 400px; overflow-y: scroll;">
                    <div class="table-responsive">
                        ...
                        <asp:SqlDataSource ID="dsGrillaMaquina" runat="server" ConnectionString="<%$ ConnectionStrings:Modelo10 %>" SelectCommand="SELECT * FROM [CosechaMaquina] WHERE Producto = '32' AND ((Fundo LIKE  @ID_Fundo + '%') AND (Potrero LIKE @ID_Potrero + '%') AND (Sector LIKE @ID_Sector + '%') AND (Cuartel LIKE @ID_Cuartel + '%') AND (Variedad LIKE @ID_Variedad + '%')) AND [Fecha] BETWEEN (@Fecha1 + '') AND (@Fecha2 + '') ORDER BY [Fecha]">
                            <SelectParameters>
