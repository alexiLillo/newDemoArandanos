...
{
    public partial class TrabajadoresManzanos1 : System.Web.UI.Page
    {
        ...
        protected void ExportToExcel(object sender, EventArgs e)
        {
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                //To Export all pages
                grillaTrabajadores.AllowPaging = false;
                grillaTrabajadores.DataBind();

                grillaTrabajadores.Columns[0].Visible = false;

                grillaTrabajadores.HeaderRow.BackColor = Color.White;
                foreach (TableCell cell in grillaTrabajadores.HeaderRow.Cells)
                {
                    cell.BackColor = grillaTrabajadores.HeaderStyle.BackColor;
                }
                foreach (GridViewRow row in grillaTrabajadores.Rows)
                {
                    ...
                    foreach (TableCell cell in row.Cells)
                    {
                        if (row.RowIndex % 2 == 0)
                        {
                            cell.BackColor = grillaTrabajadores.AlternatingRowStyle.BackColor;
                        }
                        else
                        {
                            cell.BackColor = grillaTrabajadores.RowStyle.BackColor;
                        }
                        cell.CssClass = "textmode";
                    }
                }

                grillaTrabajadores.RenderControl(hw);
                ...
                grillaTrabajadores.Columns[0].Visible = true;
            }
        }
