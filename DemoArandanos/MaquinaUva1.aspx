<%@ Page Title="" Language="C#" MasterPageFile="~/MasterUva1.Master" AutoEventWireup="true" CodeBehind="MaquinaUva1.aspx.cs" Inherits="DemoArandanos.MaquinaUva1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<h1>Cosecha Viñedos Contratistas</h1>
    <br />
    <form runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel2" UpdateMode="Always" runat="server">
            <ContentTemplate>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-2">
                        <br />
                        <label for="txtBandejas">Bins</label>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" style="max-height: 500px; overflow-y: scroll; font-size: 100%">
                            <div class="table-responsive">
                                ...
                                <asp:SqlDataSource ID="dsCosechaMaquina" runat="server" ConnectionString="<%$ ConnectionStrings:Modelo %>" SelectCommand="SELECT * FROM [CosechaMaquina] WHERE Producto = '33' AND [Fecha] BETWEEN (@Fecha + '') AND (@Fecha2 + '') ORDER BY [Fecha]">
                                    <SelectParameters>
