<%@ Page Title="" Language="C#" MasterPageFile="~/MasterManza2.Master" AutoEventWireup="true" CodeBehind="MaquinaManzanos2.aspx.cs" Inherits="DemoArandanos.MaquinaManzanos2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<h1>Cosecha Manzanos Contratistas</h1>
    <br />
    <form runat="server">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" style="max-height: 500px; overflow-y: scroll; font-size: 100%">
                            <div class="table-responsive">
                                ...
                                <asp:SqlDataSource ID="dsCosechaMaquina" runat="server" ConnectionString="<%$ ConnectionStrings:Modelo %>" SelectCommand="SELECT * FROM [CosechaMaquina] WHERE Producto = '25' AND [Fecha] BETWEEN (@Fecha + '') AND (@Fecha2 + '') ORDER BY [Fecha]">
                                    <SelectParameters>
