...
{
    public partial class InformeRankCuadrilla3 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                lblinfo.Text = "Los valores para cada cuadrilla varían según el rango de fecha asignado";
        ...
        protected void ExportToExcel(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Ranking-Cuadrillas-Manzanos-'" + lbldesde.Text + "' - '" + lblhasta.Text + "' -" + lblfiltr.Text + ".xls");
            Response.Charset = "";
