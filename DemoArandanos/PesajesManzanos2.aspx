<%@ Page Title="" Language="C#" MasterPageFile="~/MasterManza2.Master" AutoEventWireup="true" CodeBehind="PesajesManzanos2.aspx.cs" Inherits="DemoArandanos.PesajesManzanos2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<h1>Registros de Bins Manzanos</h1>
    <br />
    <form runat="server">
