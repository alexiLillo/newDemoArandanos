...
{
    public partial class InformeMaquinaUva2 : System.Web.UI.Page
    {
        ...
        protected void ExportToExcel(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Produccion-Contratistas-Uvas-" + lblvaried.Text + "-" + lblfund.Text + "-" + lblpotrer.Text + "-" + lblsect.Text + "-" + lblcuart.Text + "-'" + lbldesde.Text + "'-'" + lblhasta.Text + "'-.xls");
            Response.Charset = "";
