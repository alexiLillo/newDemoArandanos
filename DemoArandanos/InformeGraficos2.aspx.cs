...
{
    public partial class InformeGraficos2 : System.Web.UI.Page
    {
        ...
        public void load()
        {
            ...
            cargarGrafico(GraficoVariedad, control.getCantidadPorVariedad(ddEnvaseOKilo.SelectedValue, "32", ddFundo.SelectedValue, ddPotrero.SelectedValue, ddSector.SelectedValue, ddCuartel.SelectedValue, DateTime.Parse(inicio), DateTime.Parse(fin)), control.getVariedades("32"), true);
            cargarGrafico(GraficoCuartel, control.getCantidadTotal(ddEnvaseOKilo.SelectedValue, "32", ddFundo.SelectedValue, ddPotrero.SelectedValue, ddSector.SelectedValue, DateTime.Parse(inicio), DateTime.Parse(fin)), control.getNombres("32", ddFundo.SelectedValue, ddPotrero.SelectedValue, ddSector.SelectedValue), false);
        }
