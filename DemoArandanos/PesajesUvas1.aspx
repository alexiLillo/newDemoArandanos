<%@ Page Title="" Language="C#" MasterPageFile="~/MasterUva1.Master" AutoEventWireup="true" CodeBehind="PesajesUvas1.aspx.cs" Inherits="DemoArandanos.PesajesUvas1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<h1>Registros de Bins Uvas</h1>
    <br />
    <form runat="server">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" style="max-height: 500px; overflow-y: scroll; font-size: 83%">
                            <div class="table-responsive">
                                ...
                                <asp:SqlDataSource ID="dsPesajesFiltrados" runat="server" ConnectionString="<%$ ConnectionStrings:Modelo9 %>" SelectCommand="SELECT * FROM [Pesaje] WHERE Producto = '33' and (([RutTrabajador] LIKE '%' + @RutTrabajador + '%' OR [QRenvase] LIKE '%' + @RutTrabajador + '%' OR [RutPesador] LIKE '%' + @RutTrabajador + '%') AND [FechaHora] BETWEEN (@FechaHora + ' 00:00') AND (@FechaHora2 + ' 23:59')) ORDER BY [FechaHora]">
                                    <SelectParameters>
