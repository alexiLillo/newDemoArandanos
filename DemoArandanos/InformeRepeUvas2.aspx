<%@ Page Title="" Language="C#" MasterPageFile="~/MasterUva2.Master" AutoEventWireup="true" CodeBehind="InformeRepeUvas2.aspx.cs" Inherits="DemoArandanos.InformeRepeUvas2" %>
                    ...
                    <div class="panel-body" style="max-height: 480px; overflow-y: scroll; font-size: 83%">
                        <div class="table-responsive">
                            ...
                            <asp:SqlDataSource ID="dsRepetidas" runat="server" ConnectionString="<%$ ConnectionStrings:Modelo11 %>" SelectCommand="
                                                SELECT *
                                                FROM dbo.Pesaje
                                                WHERE dbo.Pesaje.Producto = '33' and (CONVERT (VARCHAR(10), FechaHora, 103) = @Fecha)
