...
{
    public partial class MaquinaUva2 : System.Web.UI.Page
    {
        ...
        protected void btGuardarCosechaMaquina_Click(object sender, EventArgs e)
        {
            if (ddFundo.SelectedValue != "0" && ddPotrero.SelectedValue != "0" && ddSector.SelectedValue != "0" && ddVariedad.SelectedValue != "0")
            {
                try
                {
                    ...
                    control.insertarCosechaMaquina("33", ddFundo.SelectedValue, ddPotrero.SelectedValue, ddSector.SelectedValue, ddVariedad.SelectedValue, ddCuartel.SelectedValue, DateTime.Parse(txtFechaCosecha.Text), pesoNeto, bandejas, txtGuia.Text, txtRecepcion.Text, txtDescripcion.Text);
