<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/Maestra.Master" AutoEventWireup="true" CodeBehind="Informes.aspx.cs" Inherits="DemoArandanos.Informes" %>
                    ...
                    <ContentTemplate>
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <asp:Button ID="btVerHileras" class="btn btn-default" runat="server" Text="Ver" OnClick="btVerHileras_Click" />
                            </span>
                        </div>
