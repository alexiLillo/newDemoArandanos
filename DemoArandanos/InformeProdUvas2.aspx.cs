...
{
    public partial class InformeProdUvas2 : System.Web.UI.Page
    {
        ...
        protected void ExportToExcel(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Produccion-Vinedos-" + lblcateg.Text + "-" + lblvaried.Text + "-" + lblfund.Text + "-" + lblpotrer.Text + "-" + lblsect.Text + "-" + lblcuart.Text + "-'" + lbldesde.Text + "'-'" + lblhasta.Text + "'-" + lblfiltr.Text + ".xls");
            Response.Charset = "";
