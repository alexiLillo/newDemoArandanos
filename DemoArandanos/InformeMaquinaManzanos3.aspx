<%@ Page Title="" Language="C#" MasterPageFile="~/MasterManza3.Master" AutoEventWireup="true" CodeBehind="InformeMaquinaManzanos3.aspx.cs" Inherits="DemoArandanos.InformeMaquinaManzanos3" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<h1>Informe Producción Contratistas, Manzanos</h1>
    <br />
    <form runat="server">
            ...
            <div id="printableArea">
                ...
                <div class="col-md-12">
                    <div class="visible-print">
                        <h2>Informe de Producción Manzanos, Contratistas</h2>
                        <br />
                        <h5>Desde:
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="max-height: 400px; overflow-y: scroll;">
                    <div class="table-responsive">
                        ...
                        <asp:SqlDataSource ID="dsGrillaMaquina" runat="server" ConnectionString="<%$ ConnectionStrings:Modelo10 %>" SelectCommand="SELECT * FROM [CosechaMaquina] WHERE Producto = '25' AND ((Fundo LIKE  @ID_Fundo + '%') AND (Potrero LIKE @ID_Potrero + '%') AND (Sector LIKE @ID_Sector + '%') AND (Cuartel LIKE @ID_Cuartel + '%') AND (Variedad LIKE @ID_Variedad + '%')) AND [Fecha] BETWEEN (@Fecha1 + '') AND (@Fecha2 + '') ORDER BY [Fecha]">
                            <SelectParameters>
