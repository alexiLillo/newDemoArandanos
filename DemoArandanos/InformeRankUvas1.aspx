<%@ Page Title="" Language="C#" MasterPageFile="~/MasterUva1.Master" AutoEventWireup="true" CodeBehind="InformeRankUvas1.aspx.cs" Inherits="DemoArandanos.InformeRankUvas1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div class="hidden-print">
        <h1>Ranking de Trabajadores Viñedos</h1>
        <br />
    </div>
    <form runat="server">
        ...
        <div class="visible-print">
            <div class="col-md-12">
                <div class="visible-print">
                    <h2>Ranking de Trabajadores Viñedos</h2>
                    <br />
                    <h5>Desde:
...
<%--                                    <asp:BoundField DataField="Cuadrilla" HeaderText="Cuadrilla" SortExpression="Cuadrilla" HtmlEncode="False" />--%>
                            ...
                            <asp:SqlDataSource ID="dsRanking" runat="server" ConnectionString="<%$ ConnectionStrings:Modelo11 %>" SelectCommand="SP_VistaRankingUvas" SelectCommandType="StoredProcedure">
                                <SelectParameters>
